...
y_train_pred_over, y_val_pred_over, train_score_over, val_score_over = over_sampling(X_toy, y_toy, strat = 0.05)

y_train_pred_under, y_val_pred_under, train_score_under, val_score_under = under_sampling(X_toy, y_toy, strat = 0.12)
